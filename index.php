...
<div class="col-md-2 col-md-offset-4">
    ...
    <a href="#" class="pull-right btn sub1" data-toggle="modal" data-target="#login">Admin Login</a>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your adddress" class="form-control input-md" type="text">
