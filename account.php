...
<div class="row">
<div class="col-lg-6">
<span class="logo">Profile</span></div>
...
if($s>=8){echo" <h3>You have succesfully passed the Test!You are now certified </h3>";}
else{echo"Unfortunately you did not passed the Test!Please Try Again";}
