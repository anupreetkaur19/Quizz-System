...
<div class="row">
<div class="col-lg-6">
<span class="logo">ADMIN SECTION</span></div>
<?php
...
<tr style="color:red"><td><b>S.no</b></td><td><b>Name</b></td><td><b>Score</b></td><td><b>Pass/Fail</b></td></tr>';
$c=0;
...
if($s>=8)
{
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$s.'</td><td>Pass</td><td>';
//echo 'Average score :$a';

}
else{
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$s.'</td><td>Fail</td><td>';
}
}
echo '</table></div>';
{
$result = mysqli_query($con,"SELECT SUM(score) AS value_sum FROM rank"); 
$row = mysqli_fetch_assoc($result); 
$sum = $row['value_sum'];
echo "<h1>Total Sum of Total Student:$sum </h1>";
}
{
$result = mysqli_query($con,"SELECT AVG(score) AS value_sum FROM rank"); 
$row = mysqli_fetch_assoc($result); 
$sum = $row['value_sum'];
echo "<h1>Total Average of Student:$sum </h1>";
}
...
echo "Total Number of student:<b>$a</b>" ;
echo '</table></div>';
